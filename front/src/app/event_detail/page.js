...
export default function () {
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="relative flex flex-col p-5 overflow-hidden bg-white rounded-lg shadow-lg w-max sm:w-3/4 sm:flex-row">
                <div className="flex items-center p-5 shrink sm:w-2/5">
                    <img src="/assets/tango.png" alt="Event" className="block w-full h-auto" />
                </div>
                <Card className="flex-1 p-5 sm:w-3/5">
                    <CardHeader className="p-6 bg-gray-50">
                        <CardTitle className="mb-2 text-xl font-semibold text-gray-700">Tango</CardTitle>
